class GraphData {
  //Created by Liam Power and Patrick Boyle  
  void main() { 
    ...
    routes = routeFinder(targetCity);
    routeFlights = routeFlights(routes, targetCity);
  ...
  String[] routeFinder(String targetCity) {
    ...
    String[] routes = null;
    routes = routesAL.toArray(new String[routesAL.size()]);
    
    return routes;
  }
  
  Integer[] routeFlights(String[] routes, String targetCity) {
    
    Integer[] routeFlights = new Integer[routes.length];
