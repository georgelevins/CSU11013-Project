class Info {
 ...
 Info() {
  ...
  String getLongestDistance() {
    ...
    String start = row.getString("ORIGIN_CITY_NAME");
    String end = row.getString("DEST_CITY_NAME");
   return ("The longest flight is from  "+ start + " to " + end + " for "  + hours + ":" + minutes + " hours");
  }
