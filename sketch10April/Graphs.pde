class Graphs {
  ...
  void drawGraphs(Integer[] tOF, Integer[] tDF, Integer[] flightsPD, int pageCount, String[] longestDiversions, String[] routesA, Integer[] routeFlightsA, Integer[] dailyFlights, String[] routesD, Integer[] routeFlightsD) {
    ...
    if (pageCount == 1) {
      ...
      drawGraph3 = true;
      drawGraph3(longestDiversions, routesA, routeFlightsA, dailyFlights, routesD, routeFlightsD);
    }
    ...
    if (drawGraph1 == true) {
      ...
      if (green1_100k) {
        ...
        for (int i = 0; i < cities.length; i++) {
          ...
          fill(255, 0, 0);
          rect(xPosGraphs, 750, 2, -(tOF / zoom1_100k));
      ...
      if (red1_100k) {
        ...
        for (int i = 0; i < cities.length; i++) {
          ...
          fill(0, 255, 0);
          rect(xPosGraphs, 750, 2, -(tDF / zoom1_100k));
  ...
  void drawGraph3(String[] longestDiversions, String[] routesA, Integer[] routeFlightsA, Integer[] dailyFlights, String[] routesD, Integer[] routeFlightsD) {
    ...
    if (drawGraph3 == true) {
      ...
      int currentXAD = 120;
      int currentYAD = 750 -(routeFlightsA[0]/5);
      int previousXAD = 0;
      int previousYAD = 0;
      ...
      for (int l = 0; l < routesA.length; l++) {
        ...
        rect(xAD, 750, 10, -(routeFlightsA[l] / 5));
    
        xAD += 10;
    
        spaceTopLeftXAD = xAD - 10;
        spaceTopRightXAD = xAD;
        spaceTopRightYAD = 750 - routeFlightsA[l] / 5;
        ...
        if (mouseX > spaceTopLeftXAD && mouseY > spaceTopRightYAD &&
            ...
            textSize(20);
            text(routesA[l] + " -  #" + routeFlightsA[l], xAD - 10, 750 - routeFlightsA[l] / 5 - 50);
      ...
      int currentXADd = 120;
      int currentYADd = 750 -(routeFlightsD[0]/5);
      int previousXADd = 0;
      int previousYADd = 0;
      ...
      for (int l = 0; l < routesD.length; l++) {
        ...
        rect(xADd, 750, 10, -(routeFlightsD[l] / 5));
    
        xADd += 10;
    
        spaceTopLeftXADd = xADd - 10;
        spaceTopRightXADd = xADd;
        spaceTopRightYADd = 750 - routeFlightsD[l] / 5;
        ...
        if (mouseX > spaceTopLeftXADd && mouseY > spaceTopRightYADd &&
            ...
            textSize(20);
            text(routesD[l] + " -  #" + routeFlightsD[l], xADd - 10, 750 - routeFlightsD[l] / 5 - 50);
  ...
  void drawBackground() {
    ...
    rect(0, 0, 1230, 50);  // Top Margin
    rect(0, 780, 1230, 50); // Bottom Margin
    
    rect(0, 0, 50, 780); // Left Margin
    rect(1180, 0, 50, 820); // Right Margin
    
    fill(240); 
    rect(50, 20, 500, 25, 20); // TITLE BAR
    
    fill(0, 0, 255); // Home Button // Needs an Image
    rect(560, 20, 50, 25, 20);
  ...
  void main() {
    ...
    if (callGraphs) {
      graphs.drawGraphs(tOF, tDF, flightsPD, pageCount, longestDiversions, routesA, routeFlightsA, dailyFlights, routesD, routeFlightsD);
    }
  }
}
